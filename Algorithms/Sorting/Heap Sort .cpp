...
/**
 * Hàm Heapify sẽ kiểm tra nút trái, nút phải và nút ngay tại gốc (root) để tìm
 * ra nút có giá trị lớn nhất.
 * Trong trường hợp nút có giá trị lớn nhất không phải nút ở vị trí gốc (root),
 * hàm sẽ đổi giá trị 2 nút này và tiếp tục đệ quy Heapify từ vị trí nút có giá
 * trị lớn nhấtđể đi đến các nhánh tiếp theo để đảm bảo nút cha sẽ luôn có
 * giá trị lớn hơn các nút con
 */
